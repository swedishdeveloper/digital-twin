...
const nearest = (position: Position, layers: string = 'address,venue'): Promise<any> => {
...
const search = (name: string, near: Position | null = null, layers: string = 'address,venue', size: number = 1000): Promise<any[]> => {
